...
public:
   static std::array<Comportement*, 4> comportementArray;   ///< tableau des comportements
   static std::array<Comportement*, 4> initComportements(); ///< initialisation du tableau de comportements
...
public :
   ...
   void action(Milieu & monMilieu);          ///< méthode d'action appelé à chaques tours
   void draw(UImg & support);                ///< méthode d'affichage sur l'environnement
